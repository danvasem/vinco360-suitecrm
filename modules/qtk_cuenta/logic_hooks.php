<?php
 ...
 $hook_array['after_relationship_delete'][] = array(2, 'RemueveGrupoSeguridad', 'custom/modules/qtk_seguridad_registros.php', 'cSeguridad', 'RemueveGrupoSeguridadRegistroVinco');
